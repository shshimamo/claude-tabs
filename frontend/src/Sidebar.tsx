...
const STATUS_CONFIG: Record<string, { label: string; icon: string; color: string }> = {
  ...
  waiting_input:       { label: '回答待ち',     icon: '❓', color: '#f9e2af' },
  permission_required: { label: '許可待ち',     icon: '🔐', color: '#fab387' },
  idle:                { label: '入力待ち',     icon: '💤', color: '#a6e3a1' },
      ...
      <div className="sidebar-content">
        {grouped.map(group => (
          <div key={group.status} className="sidebar-group">
            <div className="sidebar-group-label" style={{ backgroundColor: group.config.color + '20' }}>
